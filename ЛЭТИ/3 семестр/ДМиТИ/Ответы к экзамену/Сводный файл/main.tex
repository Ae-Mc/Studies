...
Пример:
$\sqrt{28} = 5 + (\sqrt{28} -5) = 5 + \dfrac{1}{\dfrac{1}{\sqrt{28} - 5}} = 5 + \dfrac{1}{\dfrac{\sqrt{28} + 5}{3}} =  5 + \dfrac{1}{3 + \dfrac{\sqrt{28}-4}{3}} = 5 + \dfrac{1}{3 + \dfrac{1}{\dfrac{3}{\sqrt{28}-4}}} \vspace{1 ex}$

$\dfrac{3}{\sqrt{28} -4} = \dfrac{3(\sqrt{28} + 4)}{12} = 2 + \dfrac{\sqrt{28} - 4}{4} =|\dfrac{4}{\sqrt{28} - 4} \dfrac{\sqrt{28} + 4}{3} = 3 + \dfrac{\sqrt{28} - 5}{3}| \vspace{1 ex}$

$\dfrac{3}{\sqrt{28} -5} = \sqrt{28} + 5 = 10 (\sqrt{28} - 5)...$ итого: $\sqrt{28} = [5;3,2,3,10] = [5;(3,2,3,10)]$
